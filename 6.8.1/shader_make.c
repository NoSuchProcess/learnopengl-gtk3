...
GLuint shader_make()
{
	...
	extern const GLchar _binary____shader_fragment_glsl_start;
	extern const GLchar _binary____shader_fragment_glsl_end;
	...
	fragment = shader_compile(GL_FRAGMENT_SHADER, &_binary____shader_fragment_glsl_start, &_binary____shader_fragment_glsl_end - &_binary____shader_fragment_glsl_start);
